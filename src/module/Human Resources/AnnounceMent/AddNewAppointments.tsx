...
import AppointmentDateAndSlots from "../../Appointments/Components/AppointmentDateAndSlots";
// import {
// 	createAppointment,
// 	fetchAllAppointments,
// 	updateAppointments,
// } from "./store/appointmentMiddleware";
import { AddAppointmentStateType } from "../../Appointments/store/appointmentsType";
    ...
    >
      ...
      <div className="one__input__container">
        <TextAreaComponent
          ...
          subText="Add a few lines about the announcement"
          cols={53}
          name="notes"
          value={state.notes}
          onChange={handleChange}
