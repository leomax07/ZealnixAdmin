...
// import OpenModel from "./AnnounceMent/OpenModel/OpenModel";
// import AddNewAppointments from "../Appointments/AddNewAppointments";
import AddNewAnnounceMent from "./AnnounceMent/AddNewAppointments";
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <AddNewAnnounceMent visible={visible} setVisible={setVisible} />
