  ...
  return (
    <div className="view__report__container">
      ...
      <div className="tabs__container">
        ...
        />
         {(selectedTab === 0 || selectedTab === 2) && <AssetIndex selectedtab={selectedTab}  handleClick={handleAddNewClick}/>}
        ...
        {selectedTab===2&&<MaintenanceAssetTable assetData={assetData}/>}
         ...
         <AddNewAssetItem visible={showAddNewAsset} assetData={assetData} setVisible={setShowAddNewAsset} />
