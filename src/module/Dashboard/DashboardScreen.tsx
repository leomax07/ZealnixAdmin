...
import setdata from "./Dashboard.mock";
...
function DashboardScreen() {
	...
	const fetchAppointmentCount = async () => {
		...
		setState({
			// currentWeekAppointmentCount: unwrapResult(currentWeekAppointmentCount).count,
			...
			currentWeekAppointmentCount: setdata.currentWeekAppointmentCount,
			lastWeekAppointmentCount: setdata.lastWeekAppointmentCount,
			currentWeekPatientCount: setdata.currentWeekPatientCount,
			lastWeekPatientCount: setdata.lastWeekPatientCount,
		});
	};
	...
	return (
		<div className="dashbord__container">
			<div className="top__container card">
				<Stats
					currentWeekCount={state.currentWeekAppointmentCount}
					lastWeekCount={state.lastWeekAppointmentCount}
					title="Appointments"
				/>
				<div className="v_s" />
				<Stats
					currentWeekCount={state.currentWeekPatientCount}
					lastWeekCount={state.lastWeekPatientCount}
					title="Patients"
				/>
				<div className="v_s" />
				<Stats
